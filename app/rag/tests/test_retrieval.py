...
Run:
    uv run python app/rag/tests/test_retrieval.py
...
# ── Project root on sys.path (needed when run as app/rag/tests/test_retrieval.py) ─
...
from app.core.retrieval.hybrid import _tokenize, _BM25_STOPWORDS  # noqa: E402
...
from app.core.retrieval import get_retrieval_config  # noqa: E402
...
from app.core.retrieval import compound_retrieve  # noqa: E402
...
from app.core.retrieval.base import _fetch_project_corpus  # noqa: E402
...
from app.core.retrieval import analytical_retrieve  # noqa: E402
...
from app.core.retrieval import topic_summary_retrieve  # noqa: E402
from app.core.storage.project_store import get_meeting_ids_for_project  # noqa: E402
