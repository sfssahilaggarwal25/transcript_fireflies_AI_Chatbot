...
Usage:
    python -m app.rag.tests.report_generator                        # latest run
    python -m app.rag.tests.report_generator --run 2026-05-20_11-06  # specific run
"""
...
def find_run_folder(run_id: str | None) -> Path:
    ...
    if not _RESULTS_DIR.exists():
        ...
        print("        Run the test runner first: python -m app.rag.tests.test_runner --project-id <id>")
        sys.exit(1)
